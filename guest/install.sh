#!/bin/bash
# Install Swaytastic guest tree onto this user: packages + $HOME/.config + session hooks.
set -euo pipefail
...
# older guest installs pulled qt5ct only for Brave QT; that stack is unused now
